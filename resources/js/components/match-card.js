...
export const renderMatchCard = (partido) => {
    ...
    return `<li
        class="match-card bg-light border border-complementary-dark rounded-3xl flex flex-col overflow-hidden min-w-sm xl:w-full xl:max-w-lg 2xl:max-w-xl shadow-md shadow-zinc-400 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 ease-in-out"
