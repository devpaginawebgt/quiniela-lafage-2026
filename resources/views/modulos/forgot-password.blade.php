    ...
    <div class="relative min-h-screen w-full">
        ...
        >
            <div>
                ...
                {{-- Title --}}
                <h1 class="text-3xl text-center font-bold text-light mb-8">Recuperar contraseña</h1>
            </div>
            ...
            >
                ...
                >
                    ...
                    >
                        <span class="icon-[material-symbols--send-outline] w-5 h-5"></span>
                        Enviar enlace
                    </button>
                </form>
                ...
                <div class="text-center mt-8">
                    <p class="text-dark text-sm mb-2">¿Recordaste tu contraseña?</p>
