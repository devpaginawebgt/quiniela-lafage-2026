<ul class="space-y-1">
    ...
    <li>
        <a href="{{ route('web.admin.reports.users.index') }}"
            ...
            'hover:bg-complementary-primary/60' => ! request()->routeIs('web.admin.reports.users.*'),
            ])>
    ...
    <li>
        <a href="{{ route('web.admin.reports.predictions.index') }}"
            ...
            'hover:bg-complementary-primary/60' => ! request()->routeIs('web.admin.reports.predictions.*'),
            ])>
    ...
    <li>
        <a href="{{ route('web.admin.notifications.create') }}"
            @class([
                ...
                'hover:bg-complementary-primary/60' => ! request()->routeIs('web.admin.notifications.create'),
            ])>
