...
@else
<div class="py-6 px-4 lg:px-8 bg-secondary-light rounded-t-4xl h-full flex-1">
    <h1 class="text-3xl 2xl:text-4xl text-center text-dark font-bold mt-2 mb-4">
        {{ $line->name }}
    </h1>
    <h2 class="text-lg lg:text-xl text-center text-dark font-semibold mb-8">Ranking 2026</h2>
