    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="width:600px; max-width:600px; background:#FFFFFF; border-radius:10px; overflow:hidden;">
          ...
          <tr>
            <td align="center" style="padding:30px 20px 30px 20px; background:#202453;">
              <img
          ...
          <tr>
            <td align="center" style="padding:15px 20px; background:#de2b1f; color:#FFFFFF; font-size:12px;">
              {{ config('app.name') }} · Notificación del sistema
            </td>
          </tr>
